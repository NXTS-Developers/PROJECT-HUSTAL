<?php
namespace HansAdema\AnakeClient\Message;
...
abstract class AbstractResponse {
    ...
    public function getMessage() {
		if(is_array($this->getData()) && is_array($this->getData()['result']['statusmsg'])) {
			return empty($this->getData()['result']['status']) ? trim($this->getData()['result']['statusmsg']) : $this->getData()['result']['statusmsg'];
        } else {
