...
$link="https://".$_SERVER['HTTP_HOST']."/clientarea/activate.php?key=$key&uid=$uid&activate=true";
$mail->Body=" <div class='container' style='margin-left:5%;margin-right:5%;margin-top:5%;'>
